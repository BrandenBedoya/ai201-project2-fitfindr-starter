...
def handle_query(user_query: str, wardrobe_choice: str) -> tuple[str, str, str]:
    ...
    if not user_query or not user_query.strip():
        return "Please enter a search query above.", "", ""
    ...
    # Step 4: If the interaction ended early, surface the error
    if session["error"]:
        return session["error"], "", ""

    # Step 5: Format selected_item into a readable listing panel
